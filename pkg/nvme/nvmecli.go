...
func cliVersion(executor *nslib.Executor) (major, minor int, err error) {
	opts := []string{
		"--version",
	}
...
func showHostNQN(executor *nslib.Executor) (string, error) {
	opts := []string{
		"--show-hostnqn",
	}
...
func listSubsystems(devicePath string, executor *nslib.Executor) ([]Subsystem, error) {
...
func listSubsystemsV1(jsonStr string, executor *nslib.Executor) ([]Subsystem, error) {
...
func listSubsystemsV2(jsonStr string, executor *nslib.Executor) ([]Subsystem, error) {
...
func listControllers(executor *nslib.Executor) ([]CliDevice, error) {
	opts := []string{
		"list",
		"-o", "json",
	}
...
func discovery(ip, port string, executor *nslib.Executor) ([]DiscoveryPageEntry, error) {
...
func connect(hostNQN, nqn, transpotType, ip, port string, executor *nslib.Executor) (string, error) {
	var err error
...
func disconnect(nqn string, executor *nslib.Executor) error {
	opts := []string{
		"disconnect",
		"--nqn", nqn,
	}
